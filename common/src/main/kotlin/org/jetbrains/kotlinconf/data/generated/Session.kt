...
data class Session(
    ...
    object serializer : KSerializer<Session> {
        override val serialClassDesc: KSerialClassDesc =
                object : SerialClassDescImplTagged("org.jetbrains.kotlinconf.data.generated.Session") {
            init {
                addElement("id")
...
data class SessionGroup(
    ...
    object serializer : KSerializer<SessionGroup> {
        override val serialClassDesc: KSerialClassDesc =
                object : SerialClassDescImplTagged("org.jetbrains.kotlinconf.data.generated.SessionGroup") {
            init {
